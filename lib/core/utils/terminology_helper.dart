  ...
  static const Map<String, BusinessTerminology> _mappings = {
    'Health and Fitness': BusinessTerminology(
      ...
      reminderMessageTemplate:
          "Dear {customer_name},\n\nThis is a reminder from {shop_name} that your subscription is expiring in {days_left} days ({end_date}).\n\nPlease {renew_label} to ensure your service continues without interruption. Thank you!",
    ),
