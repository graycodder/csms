...
class OnboardingPageWeb extends StatefulWidget {
  const OnboardingPageWeb({super.key});

  @override
  State<OnboardingPageWeb> createState() => _OnboardingPageWebState();
}

class _OnboardingPageWebState extends State<OnboardingPageWeb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF9FAFB), // Slightly off-white for web
      appBar: AppBar(
