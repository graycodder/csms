...
class RenewSubscriptionPageWeb extends StatefulWidget {
  ...
  const RenewSubscriptionPageWeb({
    super.key,
  ...
  @override
  State<RenewSubscriptionPageWeb> createState() =>
      _RenewSubscriptionPageWebState();
}

class _RenewSubscriptionPageWebState extends State<RenewSubscriptionPageWeb> {
  int? _selectedValue;
      ...
      builder: (_) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('Duration: $_selectedLabel', style: TextStyle(fontSize: 15)),
              SizedBox(height: 8),
              if (isActive) ...[
                SizedBox(height: 4),
                Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.validityType != 'flexible') ...[
                      ...
                      // Duration grid
                      if (widget.validityUnit.toLowerCase().contains(
                        'month',
                      )) ...[
                        Row(
                          children: [
                            Expanded(
                              child: _durationBtn('1 Month', 1, 'Months'),
                            ),
                            SizedBox(width: 12),
                            Expanded(
                              child: _durationBtn('3 Months', 3, 'Months'),
                            ),
                          ],
                        ),
                        SizedBox(height: 12),
                        Row(
                          children: [
                            Expanded(
                              child: _durationBtn('6 Months', 6, 'Months'),
                            ),
                            SizedBox(width: 12),
                            Expanded(
