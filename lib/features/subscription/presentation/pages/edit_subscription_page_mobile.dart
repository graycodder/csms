...
class EditSubscriptionPageMobile extends StatefulWidget {
  ...
  const EditSubscriptionPageMobile({
    super.key,
  ...
  @override
  State<EditSubscriptionPageMobile> createState() => _EditSubscriptionPageMobileState();
}

class _EditSubscriptionPageMobileState extends State<EditSubscriptionPageMobile> {
