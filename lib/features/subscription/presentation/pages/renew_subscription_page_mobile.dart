...
class RenewSubscriptionPageMobile extends StatefulWidget {
  ...
  const RenewSubscriptionPageMobile({
    super.key,
  ...
  @override
  State<RenewSubscriptionPageMobile> createState() => _RenewSubscriptionPageMobileState();
}

class _RenewSubscriptionPageMobileState extends State<RenewSubscriptionPageMobile> {
  int? _selectedValue;
