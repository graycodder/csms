...
class CustomerListPageMobile extends StatefulWidget {
  final BusinessTerminology term;
  final VoidCallback onReturn;
  final DashboardLoaded state;

  const CustomerListPageMobile({
    super.key,
    required this.term,
  ...
  @override
  State<CustomerListPageMobile> createState() => _CustomerListPageMobileState();
}

class _CustomerListPageMobileState extends State<CustomerListPageMobile> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    filteredCustomers.sort((a, b) {
      final aHasSubs = _hasAnySubscription(a, widget.state);
      final bHasSubs = _hasAnySubscription(b, widget.state);
