...
class AddCustomerPageMobile extends StatefulWidget {
  final List<ProductEntity> products;
  final String shopCategory;
  const AddCustomerPageMobile({
    super.key,
  ...
  @override
  State<AddCustomerPageMobile> createState() => _AddCustomerPageMobileState();
}

class _AddCustomerPageMobileState extends State<AddCustomerPageMobile> {
