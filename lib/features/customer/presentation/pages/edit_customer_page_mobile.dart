...
class EditCustomerPageMobile extends StatefulWidget {
  final CustomerEntity customer;
  final List<ProductEntity> products;
  final String shopCategory;
  final bool registrationFeeEnabled;

  const EditCustomerPageMobile({
    super.key,
  ...
  @override
  State<EditCustomerPageMobile> createState() => _EditCustomerPageMobileState();
}

class _EditCustomerPageMobileState extends State<EditCustomerPageMobile> {
