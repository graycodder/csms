...
class AddProductPageWeb extends StatefulWidget {
  final String shopId;
  ...
  @override
  State<AddProductPageWeb> createState() => _AddProductPageWebState();
}

class _AddProductPageWebState extends State<AddProductPageWeb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          // Sidebar (Placeholder if needed, or we can just have a back button header)
          // For now, let's keep it simple with a center card and a header like ShopEditPageWeb
          Expanded(
            child: Column(
