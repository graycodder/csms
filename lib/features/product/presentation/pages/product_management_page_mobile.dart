...
class ProductManagementPageMobile extends StatefulWidget {
  const ProductManagementPageMobile({super.key});

  @override
  State<ProductManagementPageMobile> createState() => _ProductManagementPageMobileState();
}

class _ProductManagementPageMobileState extends State<ProductManagementPageMobile> {
