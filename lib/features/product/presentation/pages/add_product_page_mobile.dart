...
class AddProductPageMobile extends StatefulWidget {
  final String shopId;
  ...
  @override
  State<AddProductPageMobile> createState() => _AddProductPageMobileState();
}

class _AddProductPageMobileState extends State<AddProductPageMobile> {
