...
class ShopManagementPageMobile extends StatefulWidget {
  const ShopManagementPageMobile({super.key});

  @override
  State<ShopManagementPageMobile> createState() => _ShopManagementPageMobileState();
}

class _ShopManagementPageMobileState extends State<ShopManagementPageMobile> {
  @override
