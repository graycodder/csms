...
class EditStaffPageMobile extends StatefulWidget {
  final StaffEntity staff;

  const EditStaffPageMobile({super.key, required this.staff});

  @override
  State<EditStaffPageMobile> createState() => _EditStaffPageMobileState();
}

class _EditStaffPageMobileState extends State<EditStaffPageMobile> {
