...
class EditStaffPageWeb extends StatefulWidget {
  final StaffEntity staff;

  const EditStaffPageWeb({super.key, required this.staff});

  @override
  State<EditStaffPageWeb> createState() => _EditStaffPageWebState();
}

class _EditStaffPageWebState extends State<EditStaffPageWeb> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Modify details for this staff member',
                style: TextStyle(
