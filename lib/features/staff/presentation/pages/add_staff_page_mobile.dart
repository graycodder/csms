...
class AddStaffPageMobile extends StatefulWidget {
  final String shopId;
  final String ownerId;

  const AddStaffPageMobile({super.key, required this.shopId, required this.ownerId});

  @override
  State<AddStaffPageMobile> createState() => _AddStaffPageMobileState();
}

class _AddStaffPageMobileState extends State<AddStaffPageMobile> {
